...
class Vector {
  ...
  static mix(vector0, vector1, rate) {
    ...
    return [Float.mix(vector0[0], vector1[0], rate[0]), Float.mix(vector0[1], vector1[1], rate[1])];
  }
  static inverseMix(vector0, vector1, rate) {
    if (typeof rate == "number") {
      rate = [rate, rate];
    }
    return [Float.inverseMix(vector0[0], vector1[0], rate[0]), Float.inverseMix(vector0[1], vector1[1], rate[1])];
  }
  static abs(vector) {
